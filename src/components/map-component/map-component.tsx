...
function MapComponent() {
  ...
  useEffect(() => {
    ...
    mapData.coordinates.forEach((point: any, index: number) => {
      ...
      if (geometry) {
        ...
        extent = extent ? boundingExtent([extent, pointExtent]) : pointExtent;
      }
    });
  ...
  return (
    <div style={{ height: "100%", width: "100%" }}>
      ...
      />
      <div ref={popupRef} className={`popup ${popupOpen ? "open" : ""}`}>
        {popupOpen && (
          <div
            className="popup-content"
            style={{ border: "1px", width: "400px" }}
          >
            <p>Status: {popupContent.status ? "True" : "False"}</p>
